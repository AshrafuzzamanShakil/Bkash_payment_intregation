package com.shakil.bkash_payment;

import android.content.Context;
import android.content.Intent;
import android.webkit.JavascriptInterface;

import com.shakil.bkash_payment.Activity.PaymentSuccess_Activity;

//created by Mominul Islam mominulcse7@gmail.com  08/06/2020

public class Bkash_payment_interface {
    Context mContext;
    /**
     * Instantiate the interface and set the context
     */
    public Bkash_payment_interface(Context c) {
        mContext = c;
    }
