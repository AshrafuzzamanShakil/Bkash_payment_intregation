...
import com.shakil.bkash_payment.payment_request;
import com.shakil.bkash_payment.Bkash_payment_interface;
...
public class BkashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() == null) {
            ...
            //Create a PaymentRequests

            payment_request paymentRequest = new payment_request();
             ...
             */
            wvBkashPayment.addJavascriptInterface(new Bkash_payment_interface(BkashActivity.this), "KinYardsPaymentData");
